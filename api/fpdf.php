...
*                                                                              *
*******************************************************************************/
function FPDF($orientation='P', $unit='mm', $size='A5')
{
	// Some checks
	$this->_dochecks();
	...
	// Page sizes
	$this->StdPageSizes = array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(220,595.28),
		'letter'=>array(612,792), 'legal'=>array(612,1008));//420.94,595.28
    ...
    if($start!==false && $end!==false)
    {
        ...
        for($i=1;$i<=count($tableData[0]);$i++)
        {
            if($this->CurOrientation=='L')
                $w[] = abs(38/(count($tableData[0])-1))+24;  //80 => 120
            else
                $w[] = abs(38/(count($tableData[0])-1))+5;  //80 => 120
        }
...
function WriteHTML2($html)
{
    ...
    if($start!==false && $end!==false)
    {
        ...
        {
            if($this->CurOrientation=='L')
                $w[] = abs(50/(count($tableData[0])-1))+24;  //80 => 120
            else
                $w[] = abs(50/(count($tableData[0])-1))+5;  //80 => 120
        }
        $this->WriteTable($tableData,$w);
